...
class Blockchain(object):
    ...
    def new_transaction(self, sender, recipient, amount):
        ...
        print(f"self.chain[-1]['index']: {self.chain[-1]['index']}")
...
def post_new_transaction():
    ...
    message = {
        ...
        # "blockchain.last_block": blockchain.last_block
    }
...
def mine():
    ...
    if blockchain.valid_proof(block_string, data['proof']):
        ...
        return jsonify({'message': 'success', 'block': new_block}), 200
    else:
